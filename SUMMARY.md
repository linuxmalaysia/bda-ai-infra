...
okf_version: "0.2"
type: summary_index
title: "Summary Navigation Index"
description: "Table of contents and navigation index for GitBook and documentation tools."
status: active
...
- [Root AI Gateway](AGENTS.md)
- [Sovereign AI Constitution](.agents/AGENTS.md)
- [START HERE: Onboarding Map](START-HERE.md)
- [Master Architecture Baseline](README.md)
